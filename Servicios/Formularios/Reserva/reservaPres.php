...
<head>
    ...
    <link rel="stylesheet" href="../../CSS/reservaP.css">
...
<body>
    ...
    <div class="contenedor">
        ...
        <div class="titulo">
            <h3>RESERVA PRESENCIAL</h3>
        </div>
        <div class="formulario">
            <form action="ConfirmandoReservas/ValidarReservaPre.php" method="post">
                    <h4>Dirección</h4>
                    <input class="direccion" name="direccion" type="text" value="Av. Óscar R. Benavides 450, Cercado de Lima 15082"><br><br>
                    <h4>Fecha de Reserva</h4>
                    <input class="fecha" name="fecha" type="date"><br><div class="reservar">
                        <input class="btnreserva" type="submit" name="Presencial" value="RESERVAR">
                    </div>
           </form>
        </div>
        <div class="vacio"></div>
