...
<body>
    ...
    <div class="Contenedor__Libro">
        <div>
            <h4>Producción Científica en la Base de Datos Scopus de una Universidad Privada del Perú</h4>
        </div>
        <div class="Contenido__Libro">
            <div class="Libro__Img__4">
            </div>
            <div class="Libro__Datos">
                <p>Se realizó un estudio bibliométrico analizando los artículos publicados en la base de datos Scopus que registraban
                    como afiliación del autor a la USMP, y las variables: número de publicaciones, áreas, autores, idioma, tipo de publicación,
                    revista, colaboración y citas por trabajo. Resultados: se ubicaron un total de 880 artículos. Se evidenció una tendencia al alza
                    en el número anual de publicaciones. La mayor parte de los artículos (43.7%) fueron clasificados como pertenecientes al área
                    de Medicina, seguido de Ciencias Sociales (11%) y Psicología (7.4%), los autores con mayor número de publicaciones fueron:
                    Domínguez-Lara, Merino-Soto y Fujita, 61.3% de los artículos son producidos en inglés, 58.2% de los trabajos tienen por lo
                    menos una cita.
                </p>
                <ul>
                    <li>Fecha: <span>2021</span></li>
                    <li>Materia: <span>Base de Datos</span></span></li>
                    <li>Carrera: <span>Ingenieria de Sistemas</span></li>
                    <li>Autor: <span>Rodrigo Livia-Ortiz</span></li>
                    <li>Categoria: <span>Articulo</span></li>
                </ul>
                <form action="Ingresando.php" method="post">
                    <input type="submit" name="Ver" value="Ver Pdf">
                    <input type="hidden" name="url" value="../pdfLibros/Articulos/Produccion Cientifica.pdf">
                    <input type="hidden" name="Titulo" value="Producción Científica en la Base de Datos Scopus de una Universidad Privada del Perú">
