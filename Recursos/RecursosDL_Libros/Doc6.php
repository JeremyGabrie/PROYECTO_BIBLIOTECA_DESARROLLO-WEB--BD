...
<body>
    ...
    <div class="Contenedor__Libro">
        <div>
            <h4>La Inteligencia Artificial y el gobierno electrónico en el instituto de gobernabilidad y tecnología</h4>
        </div>
        <div class="Contenido__Libro">
            <div class="Libro__Img__5">
            </div>
            <div class="Libro__Datos">
                <p>En estos tiempos con el avance de las nuevas tecnologías de información y la
                    ...
                    algoritmos que sean capaces de resolver problemas heurísticos, en este caso el
                    algoritmo genético. El objetivo de este proyecto es diseñar un software en lenguaje
                    c# con algoritmo genético que genere una lista para el análisis de los proyectos de
                    inversión pública en la plataforma de Gobierno Electrónico.
                </p>
                <ul>
                    <li>Fecha: <span>2018</span></li>
                    <li>Materia: <span>Inteligencia Artificial</span></span></li>
                    <li>Carrera: <span>Ingenieria de Sistemas</span></li>
                    <li>Autor: <span>Mugruzu Torres</span></li>
                    <li>Categoria: <span>Tesis</span></li>
                </ul>
                <form action="Ingresando.php" method="post">
                    <input type="submit" name="Ver" value="Ver Pdf">
                    <input type="hidden" name="url" value="../pdfLibros/Tesis/Inteligencia Artificial.pdf">
                    <input type="hidden" name="Titulo" value="La Inteligencia Artificial y el gobierno electrónico en el instituto de gobernabilidad y tecnología">
