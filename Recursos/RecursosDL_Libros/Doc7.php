...
<body>
    ...
    <div class="Contenedor__Libro">
        <div>
            <h4>Del concepto de ingeniería de transito al de movilidad urbana sostenible</h4>
        </div>
        <div class="Contenido__Libro">
            <div class="Libro__Img__7">
            </div>
            <div class="Libro__Datos">
                <p>El estudio de la movilidad en la ciudades se ha valido de ciencias aplicadas como la
                    ...
                    el volumen del tráfico, la velocidad y la densidad, además de inventarios de infraestructuras,
                    la generación de modelos de pronóstico y la modelación con el empleo
                    ...
                    operación del tránsito y la intervención física de la infraestructura del transporte. No
                    obstante, en la práctica, dichos estudios han dejado de lado el análisis de factores
                    esenciales como la equidad social, el ambiente y el valor económico, propios de
                    la concepción del problema de movilidad urbana en el marco de la sostenibilidad
                    de los sistemas de transporte. El presente artículo pretende proveer una prospectiva
                    de la inclusión de estos aspectos en las etapas de diagnóstico de la movilidad, así
                    como en el diseño y la planificación de medidas para su mejoramiento, y que pueden redundar en la
                    obtención de resultados efectivos por parte de expertos, funcionarios y entidades competentes,
                    concordantes con las verdaderas necesidades de
                    movilidad urbana de los individuos y su sostenibilidad.
                </p>
                <ul>
                    <li>Fecha: <span>2016</span></li>
                    <li>Materia: <span>Movilidad Urbana</span></span></li>
                    <li>Carrera: <span>Ingenieria de Transportes</span></li>
                    <li>Autor: <span>Julian Rodrigo Quintero Gonzales</span></li>
                    <li>Categoria: <span>Articulo</span></li>
                </ul>
                <form action="Ingresando.php" method="post">
                    <input type="submit" name="Ver" value="Ver Pdf">
                    <input type="hidden" name="url" value="../pdfLibros/Articulos/transporte.pdf">
                    <input type="hidden" name="Titulo" value="Del concepto de ingeniería de transito al de movilidad urbana sostenible">
