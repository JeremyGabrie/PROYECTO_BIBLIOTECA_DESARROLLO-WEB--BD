...
<body>
    ...
    <div class="Contenedor__Libro">
        <div>
            <h4>Buenas Practicas en el rol de la auditoria en las publicaciones cientificas</h4>
        </div>
        <div class="Contenido__Libro">
            <div class="Libro__Img__10">
            </div>
            <div class="Libro__Datos">
                <p>Revista cientifica  donde se puede visualizar  diferentes articulos originales como es el caso 
                    ...
                    innovaciones de la busqueda de estudio en la Ingenieria de Sistemas
                </p>
                <ul>
                    <li>Fecha: <span>2022</span></li>
                    <li>Materia: <span>Auditoria</span></span></li>
                    <li>Carrera: <span>Ingenieria de Sistemas</span></li>
                    <li>Autor: <span>Universidad Nacional de San Martin  </span></li>
                    <li>Categoria: <span>Revista</span></li>
                </ul>
                <form action="Ingresando.php" method="post">
                    <input type="submit" name="Ver" value="Ver Pdf">
                    <input type="hidden" name="url" value="../pdfLibros/Revista/27-56-PB.pdf">
                    <input type="hidden" name="Titulo" value="Buenas Practicas en el rol de la auditoria en las publicaciones cientificas">
