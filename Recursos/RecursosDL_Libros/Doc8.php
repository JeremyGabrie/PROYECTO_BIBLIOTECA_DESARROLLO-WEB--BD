...
<body>
    ...
    <div class="Contenedor__Libro">
        <div>
            <h4>Implementación del plan HACCP para poder exportar ingredientes elaborados por la empresa alitecno al mercado boliviano</h4>
        </div>
        <div class="Contenido__Libro">
            <div class="Libro__Img__8">
            </div>
            <div class="Libro__Datos">
                <p>El presente trabajo es una descripción detallada sobre la implementación del Sistema HACCP en
                    ...
                    de Salud. Los productos de exportación elaborados por la empresa Alitecno, son insumos que
                    consisten en mezclas de ingredientes en polvo a base de proteína de soya de uso en la industria
                    cárnica con fines organolépticos. Dicho plan de inocuidad fue desarrollado en base a los
                    lineamientos establecidos por el sistema de Análisis de Peligros y Puntos Críticos de Control
                    (HACCP por sus siglas en inglés), llevándose a cabo el desarrollo de todos y cada uno de los
                    principios enmarcados en dicho sistema; asimismo, se tomó como guía lo establecido por la Norma
                ...
                <ul>
                    <li>Fecha: <span>2019</span></li>
                    <li>Materia: <span>Implementacion de un sistema de exportacion</span></span></li>
                    <li>Carrera: <span>Ingenieria Agroindustrial</span></li>
                    <li>Autor: <span>Diaz Aliaga, Marianela Elva </span></li>
                    <li>Categoria: <span>Tesis</span></li>
                </ul>
                <form action="Ingresando.php" method="post">
                    <input type="submit" name="Ver" value="Ver Pdf">
                    <input type="hidden" name="url" value="../pdfLibros/Tesis/DIAZ ALIAGA MARIAELA ELVA - TITULO PROFESIONAL.pdf">
                    <input type="hidden" name="Titulo" value="Implementación del plan HACCP para poder exportar ingredientes elaborados por la empresa alitecno al mercado boliviano">
