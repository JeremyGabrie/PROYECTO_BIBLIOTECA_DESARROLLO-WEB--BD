...
<body>
    ...
    <div class="Contenedor__Libro">
        <div>
            <h4>La transnacional museística o de como hemos dejado de hacer cosas con las cosas</h4>
        </div>
        <div class="Contenido__Libro">
            <div class="Libro__Img__9">
            </div>
            <div class="Libro__Datos">
                <p>Dos nociones de Giorgio Agamben son el punto de partida de este trabajo. Por un lado, la
                    ...
                    espectadores-turistas. Me propongo al menos intentar aquí (a) pensar qué significa esta
                    “museificación”, es decir, este proceso de conversión del mundo en un espectáculo cuya
                    principal función consiste en regular los usos sociales de lo existente y crear un espacio
                    separado donde se captura la posibilidad de hacer (nuevas) cosas con las cosas. (b) Esbozar
                    una hipótesis que permita articular la tesis de la museificación y la teoría del capitalismo
                    (en especial, pensarla a la luz del postfordismo). (c) Contribuir a imaginar formas de vida
                    diferentes de las del turista, el espectador, el consumidor, el deseante insatisfecho, incluso
                    el “receptor activo”
                </p>
                <ul>
                    <li>Fecha: <span>2006</span></li>
                    <li>Materia: <span>Implementacion de un sistema </span></span></li>
                    <li>Carrera: <span>Ingenieria Industrial</span></li>
                    <li>Autor: <span>Flavia Costa  </span></li>
                    <li>Categoria: <span>Ponencia</span></li>
                </ul>
                <form action="Ingresando.php" method="post">
                    <input type="submit" name="Ver" value="Ver Pdf">
                    <input type="hidden" name="url" value="../pdfLibros/Ponencia/ponencia.pdf">
                    <input type="hidden" name="Titulo" value="La transnacional museística o de como hemos dejado de hacer cosas con las cosas">
