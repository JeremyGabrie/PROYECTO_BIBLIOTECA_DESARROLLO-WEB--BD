...
<body>
    ...
    <div class="Contenedor__Imagen">
        ...
        <h2 id="Letra" class="Nombre" style="margin-left:180px;">DOCUMENTACIÓN EN LINEA</h2>
        ...
        <div class="Contenido__DL__Contenido">
            <div class="Contenido__DL__libros">
                <div class="contenido__form">
                    <span class="titulo__busqueda">Busqueda por Categoria</span>
                    <select id="busqueda" onchange="Catego();">
                        <option class="opt" value="todos">categoria</option>
                        <option class="opt" value="libro">libro</option>
                        <option class="opt" value="ponencia">ponencia</option>
                        <option class="opt" value="articulo">articulo</option>
                        <option class="opt" value="tesis">tesis</option>
                        <option class="opt" value="revista">revista</option>
                    </select>
                </div>
                <div class="Contenido__DL__libros__1 libro">
                ...
                <div class="Contenido__DL__libros__1 articulo">
                ...
                <div class="Contenido__DL__libros__1 tesis">
                ...
                <div class="Contenido__DL__libros__1 articulo">   <!--Contenedor general, para el filtrado usando JS-->
                ...
                <div class="Contenido__DL__libros__1 libro">   <!--Contenedor general, para el filtrado usando JS-->
                ...
                <div class="Contenido__DL__libros__1 tesis">   <!--Contenedor general, para el filtrado usando JS-->
                ...
                <div class="Contenido__DL__libros__1 ponencia">   <!--Contenedor general, para el filtrado usando JS-->
                ...
                <div class="Contenido__DL__libros__1 revista">   <!--Contenedor general, para el filtrado usando JS-->
