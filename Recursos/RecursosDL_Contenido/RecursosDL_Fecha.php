...
<body>
    ...
    <div class="Contenedor__Imagen">
        ...
        <h2 id="Letra" class="Nombre" style="margin-left:150px;">DOCUMENTACIÓN EN LINEA<br><span
                id="filtro">FECHA</span></h2>
        ...
        <div class="Contenido__DL__Contenido">
            <div>
                <div class="Contenido__DL__libros">
                    <div class="contenido__form">
                        <span class="titulo__busqueda">Busqueda por Fecha</span>
                        <select id="busqueda" onchange="Catego();">
                            <option class="opt" value="todos">Fecha</option>
                    ...
                    <div class="Contenido__DL__libros__1 2006">
                    ...
                    <div class="Contenido__DL__libros__1 2009">
                    ...
                    <div class="Contenido__DL__libros__1 1998">
                    ...
                    <div class="Contenido__DL__libros__1 2021">
                        ...
                        <div>
                            ...
                            <p>Se realizó un estudio bibliométrico analizando los artículos publicados en la base de
                                ...
                                revista, colaboración<a href="../RecursosDL_Libros/Doc4.php"
                                    style="color: blue;">...ver
                                    más</a>.</p>
                            <div>
                    ...
                    <div class="Contenido__DL__libros__1 2018">
                    ...
                    <div class="Contenido__DL__libros__1 2021">
                        ...
                        <div>
                            ...
                            <p>El presente trabajo deviene de la experiencia en la municipalidad en un encuentro
                                ...
                                desarrolle
                                este trabajo como una<a href="../RecursosDL_Libros/Doc5.php"
                                    style="color: blue;">...ver
                                    más</a>.</p>
                            <div>
                                <p>Fecha: <span>2021</span></p>
                    ...
                    <div class="Contenido__DL__libros__1 2017">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 2012">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 2021">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 2020">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 2015">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 2013">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 2019">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 2006">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 2022">   <!--Contenedor general, para el filtrado usando JS-->
            ...
            <div class="Contenido__DL__Filtrado">
                ...
                <div class="Contenido__DL__Filtrado__1">
                    ...
                    <div>
                        <ul>
                            <li><a href="RecursosDL_Fecha.php">Fecha</a></li>
                            <li><a href="RecursosDL_Autor.php">Autor</a></li>
                            <li><a href="RecursosDL_Materia.php">Materia</a></li>
                            <li><a href="RecursosDL_Titulo.php">Titulo</a></li>
                            <li><a href="RecursosDL_Carrera.php">Carrera</a></li>
                        </ul>
                    </div>
                </div>
            </div>
