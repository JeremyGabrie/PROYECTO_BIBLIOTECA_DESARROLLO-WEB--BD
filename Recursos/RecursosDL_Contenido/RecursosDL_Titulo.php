        ...
        <div class="Contenido__DL__Contenido">
            <div class="Contenido__DL__libros">
                <div class="contenido__form">
                    <span class="titulo__busqueda">Busqueda por Titulo</span>
                    <input size="50px" type="text" id="busqueda" placeholder="Escriba el nombre del Titulo">
                </div>
