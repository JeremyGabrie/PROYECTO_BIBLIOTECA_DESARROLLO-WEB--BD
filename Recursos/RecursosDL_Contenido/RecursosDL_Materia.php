        ...
        <div class="Contenido__DL__Contenido">
            <div class="Contenido__DL__libros">
                <div class="contenido__form">
                    <span class="titulo__busqueda">Busqueda por Materia</span>
                    <input size="50px" type="text" id="busqueda" placeholder="Escriba el nombre de la Materia">
                </div>
