            ...
            <div>
                <div class="Contenido__DL__libros">
                    <div class="contenido__form">
                        <span class="titulo__busqueda">Busqueda por Carrera</span>
                        <select id="busqueda" onchange="Catego();">
                            <option class="opt" value="todos">Carrera</option>
                            <option class="opt" value="Sistemas">Ingenieria de Sistemas</option>
                            <option class="opt" value="Industrial">Ingenieria Industrial</option>
                            <option class="opt" value="Agroindustrial">Ingenieria Agroindustrial</option>
                            <option class="opt" value="Transporte">Ingenieria Transporte</option>
                        </select>
                    </div>
                    <div class="Contenido__DL__libros__1 Sistemas">
                    ...
                    <div class="Contenido__DL__libros__1 Sistemas Industrial Transporte Agroindustrial">
                    ...
                    <div class="Contenido__DL__libros__1 Industrial">
                    ...
                    <div class="Contenido__DL__libros__1 Industrial">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 Transporte">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 Sistema">   <!--Contenedor general, para el filtrado usando JS-->
                    ...
                    <div class="Contenido__DL__libros__1 Agroindustrial">   <!--Contenedor general, para el filtrado usando JS-->
