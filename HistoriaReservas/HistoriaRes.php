...
<head>
    ...
    <link rel="stylesheet" href="../Servicios/CSS/confirmar.css">
...
<body>
    ...
    <header class="Caja">
        ...
        <div class="Caja__Login">
            ...
            <li><p class="Login"><?php echo "$_SESSION[Nombre] $_SESSION[Apellido]";?></p>
                <ul>
                    <li><a href="HistoriaRes.php">Historial de Reservas</a></li>
    ...
    <div class="contenedor">
        ...
        <div class="usuario">
            ...
            <img src="../Servicios/img/silueta.jpg" class="silu">
        </div>
        <div class="otros">
            <img src="../Servicios/img/logo.jpg" class="logo">
        </div>
        <div class="datos">
            <p>
        ...
        <div class="container-table container-table--edit">
            <div class="table__title table__title--edit">HISTORIAL DE RESERVAS</div>
            <div class="table__header">Codigo Reserva</div>
            ...
            <?php
                $matricula="SELECT * FROM reservausuario";
                $LeerMatricula = mysqli_query($conexion,$matricula);
                while($row=mysqli_fetch_array($LeerMatricula,MYSQLI_ASSOC))
                {
                    if($row['CodigoUsuarioRes']==$_SESSION['Codigo'])
                    {?>
                        <div class="table__item"><?php echo $row['CodigoRes'];?></div>
                        <div class="table__item"><?php echo $row['NombreDoc'];?></div>
                        <div class="table__item"><?php echo $row['AutorDoc'];?></div>
                        <div class="table__item"><?php echo $row['ISBNDoc'];?></div>
                        <div class="table__item"><?php echo $row['DireccionRes'];?></div>
                        <div class="table__item"><?php echo $row['TipoRes'];?></div>
                        <div class="table__item"><?php echo $row['FechaRes'];?></div>
                        <div class="table__item"><?php echo $row['EstadoRes'];?></div>
              <?php }
                }?>
        </div>
        <?php
